      ...
      <div className={`max-w-screen-2xl container max-auto md:px-20 px-4 fixed top-0 right-0 left-0${
        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">Book_Store</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a className=" bg-blue-800 text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer">
                Login
              </a>
            </div>
          </div>
